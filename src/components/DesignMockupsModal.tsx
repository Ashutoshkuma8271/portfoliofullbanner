          ...
          <div className="p-6 sm:p-8 space-y-6 flex-1">
            ...
            <div className="space-y-4">
              ...
              <div className="p-5 bg-[#0e0e0f] border border-[#4d4635] rounded-lg space-y-3">
                ...
                <p className="font-sans text-[13px] text-[#d0c5af]">
                  The application is structured as a modern TypeScript React application built on Vite and Tailwind CSS. Clean, unbundled source code is exportable via AI Studio or GitHub integration.
                </p>
              </div>
            </div>
          </div>
