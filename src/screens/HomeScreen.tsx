...
export const HomeScreen: React.FC<HomeScreenProps> = ({
  ...
  return (
    <div className="flex flex-col w-full text-[#e5e2e3] overflow-x-hidden">
        ...
        {heroSlides.map((slide, index) => {
          ...
          return (
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-black/92 via-black/55 to-black/20 sm:from-black/95 sm:via-black/60 sm:to-black/15"></div>
              <div className="absolute inset-0 bg-gradient-to-t from-[#070707] via-black/35 to-transparent"></div>
              {/* Ambient Gold Radial Glow behind the hero typography */}
              <div className="absolute -left-16 sm:-left-20 top-1/4 w-[280px] sm:w-[600px] h-[280px] sm:h-[600px] bg-[#f2ca50]/12 rounded-full blur-[80px] sm:blur-[120px] pointer-events-none animate-gold-pulse"></div>
              <div className="absolute inset-0 hero-grain pointer-events-none"></div>
            </div>
          );
        })}
      ...
      <section className="w-full bg-[#0e0e0f] py-10 sm:py-14 border-y border-[#4d4635]/40 relative">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-20">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-3 sm:gap-4 mb-6 sm:mb-8">
            <div className="space-y-1">
              <span className="font-sans text-[10px] sm:text-[11px] font-bold text-[#f2ca50] uppercase tracking-[0.2em] sm:tracking-[0.25em] block">
                Featured Media &amp; Accredited Press
              </span>
              <p className="font-sans text-[12px] sm:text-[13px] text-[#d0c5af]">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-10 gap-3 sm:gap-4 items-center justify-items-center">
            {/* Bloomberg */}
