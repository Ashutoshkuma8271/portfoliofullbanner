            ...
            <div className="space-y-4">
              <div className="aspect-[16/9] overflow-hidden relative bg-[#14120f]">
                <img
                  ...
                  loading="lazy"
                  onError={(e) => {
                    (e.currentTarget as HTMLImageElement).src = 'https://images.unsplash.com/photo-1590283603385-17ffb3a7f29f?auto=format&fit=crop&w=1000&q=80';
                  }}
                  className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700 filter contrast-105"
                />
                <div className="absolute top-3 left-3 px-3 py-1 bg-[#0e0e0f]/85 backdrop-blur-sm border border-[#f2ca50]/40 text-[#f2ca50] font-sans text-[10px] font-bold uppercase tracking-wider rounded">
                  {post.category}
                </div>
              </div>
