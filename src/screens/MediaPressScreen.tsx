        ...
        <section className="space-y-12 animate-in fade-in duration-300">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 bg-[#181613] border border-[#3e3422] overflow-hidden rounded-2xl shadow-2xl">
            <div className="lg:col-span-7 relative min-h-[320px] sm:min-h-[400px] lg:min-h-[460px] bg-[#0c0b0a]">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#181613] via-transparent to-transparent"></div>
              <div className="absolute top-4 left-4 px-3 py-1.5 bg-[#0b0a08]/90 backdrop-blur-md border border-[#f2ca50]/50 text-[#f2ca50] font-sans text-[10px] font-bold uppercase tracking-widest rounded shadow-md flex items-center gap-2">
              ...
              {FILM_PROJECTS.map((film) => (
                ...
                >
                  <div className="aspect-[16/10] overflow-hidden relative bg-[#0c0b0a]">
                    ...
                    />
                    <div className="absolute top-2.5 right-2.5 px-2 py-0.5 bg-[#0b0a08]/85 text-[#f2ca50] text-[9px] font-bold uppercase tracking-wider rounded border border-[#f2ca50]/30">
                      {film.year}
                    </div>
                  </div>
              ...
              >
                {press.image && (
                  <div className="h-44 w-full overflow-hidden relative bg-[#0c0b0a]">
                    ...
                    />
                    <div className="absolute top-3 left-3 px-2.5 py-1 bg-[#0b0a08]/85 backdrop-blur-md rounded border border-[#f2ca50]/40 text-[#f2ca50] text-[9.5px] font-bold uppercase tracking-wider">
                      {press.publication}
                    </div>
                  </div>
                )}
